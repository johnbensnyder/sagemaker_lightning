...
def get_local_rank():
    return max(int(os.environ.get("LOCAL_RANK", 0)), int(os.environ.get("OMPI_COMM_WORLD_LOCAL_RANK", 0)))

def get_rank():
    return max(int(os.environ.get("RANK", 0)), int(os.environ.get("OMPI_COMM_WORLD_RANK", 0)))

def get_world_size():
    return max(int(os.environ.get("WORLD_SIZE", 1)), int(os.environ.get("OMPI_COMM_WORLD_SIZE", 1)))
